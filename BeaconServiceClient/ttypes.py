...
class NotifyBeaconDetected(object):
    """
    Attributes:
     - hwid
     - secureMessage
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('NotifyBeaconDetected')
...
all_structs.append(NotifyBeaconDetected)
NotifyBeaconDetected.thrift_spec = (
    None,  # 0
