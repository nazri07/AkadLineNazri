...
class Iface(object):
    def retrieveOpenIdAuthUrlWithDoCoMoRx(self):
        pass
...
class Client(Iface):
    ...
    def retrieveOpenIdAuthUrlWithDoCoMoRx(self):
        self.send_retrieveOpenIdAuthUrlWithDoCoMoRx()
        return self.recv_retrieveOpenIdAuthUrlWithDoCoMoRx()

    def send_retrieveOpenIdAuthUrlWithDoCoMoRx(self):
        self._oprot.writeMessageBegin('retrieveOpenIdAuthUrlWithDoCoMoRx', TMessageType.CALL, self._seqid)
        args = retrieveOpenIdAuthUrlWithDoCoMoRx_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_retrieveOpenIdAuthUrlWithDoCoMoRx(self):
        iprot = self._iprot
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT, "retrieveOpenIdAuthUrlWithDoCoMoRx failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap = {}
        self._processMap["retrieveOpenIdAuthUrlWithDoCoMoRx"] = Processor.process_retrieveOpenIdAuthUrlWithDoCoMoRx
    ...
    def process_retrieveOpenIdAuthUrlWithDoCoMoRx(self, seqid, iprot, oprot):
        ...
        oprot.writeMessageBegin("retrieveOpenIdAuthUrlWithDoCoMoRx", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class retrieveOpenIdAuthUrlWithDoCoMoRx_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('retrieveOpenIdAuthUrlWithDoCoMoRx_args')
...
all_structs.append(retrieveOpenIdAuthUrlWithDoCoMoRx_args)
retrieveOpenIdAuthUrlWithDoCoMoRx_args.thrift_spec = (
)


class retrieveOpenIdAuthUrlWithDoCoMoRx_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('retrieveOpenIdAuthUrlWithDoCoMoRx_result')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(retrieveOpenIdAuthUrlWithDoCoMoRx_result)
retrieveOpenIdAuthUrlWithDoCoMoRx_result.thrift_spec = (
